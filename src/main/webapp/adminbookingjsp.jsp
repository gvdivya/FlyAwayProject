...
<%@ page import="com.flyawayproject.AdminBookingDTO"%>
<!DOCTYPE html>
<%
List rList = (List)session.getAttribute("adminbookingList");
%>
<html>
<head>
...
<tr>
    ...
    %>
        <tr>
        	<td><%=((AdminBookingDTO)test).getBookingId()%> </td>
            <td><%=((AdminBookingDTO)test).getBFlightId()%> </td>
            <td><%=((AdminBookingDTO)test).getNoPax()%></td>  
            <td><%=((AdminBookingDTO)test).getBookingDate()%></td>
  			<td><%=((AdminBookingDTO)test).getEmail()%></td>
